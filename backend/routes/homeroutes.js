...
const { getallblogs, togglelikes, removelikes, rendercomments, addcomment, editcomments, delcomments, trending, popularaauthors, searching } = require("../controller/Homecontroller");
