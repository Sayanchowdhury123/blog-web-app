...
export default function Editorpicks({page}) {
...
const isper = page === "per";
    ...
    return (
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 1 }} className={`bg-white  rounded-xl ${!isper ? "w-[328px] absolute top-[22px] left-[1130px] " : "pt-1"}   shadow-lg `}>
            <div>
