...
const { getallblogs, togglelikes, removelikes, rendercomments, addcomment, editcomments, delcomments, trending, popularaauthors } = require("../controller/Homecontroller");
